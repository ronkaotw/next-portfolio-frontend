...
export default function Experience() {
  ...
  return (
    <motion.section initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} className="lg:w-full h-screen relative flex flex-col md:flex-row sm:flex-row justify-center items-center gap-36 p-10">
